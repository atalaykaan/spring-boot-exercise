...
import com.atalaykaan.cruddemo.entity.Review;
...
public class CruddemoApplication {
    ...
    private void createCourseAndReviews(AppDAO appDAO) {
        ...
        tempCourse.add(new Review("Really good course."));
        tempCourse.add(new Review("I loved it!"));
        tempCourse.add(new Review("This course sucks!"));
